...
class AIAnalyzer:
    ...
    def analyze_diff(self, diff, file_extension):
        ...
        prompt = (
            ...
            f"in realization if needed(maybe some optimization of a given algorithm) or code-style changes according to {code_style}(if no code style given choose the basic one for given language) "
            "and highlight possible errors if they may occur."
